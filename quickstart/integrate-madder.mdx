...
Drag the `MadderManager` and `MadderControllerManager` prefabs into your scene. These prefabs are Singleton classes and
will persist across scene loads. These are the core components of the Madder system and are required for Madder to work
with your game.

Additionally, drop the `SampleGameManager`, `SamplePlayerManager`, and `MadderControllerTest` prefabs into your scene.
These prefabs are examples of how you might interact with the Madder system.
