...
You may subscribe to the [OnRegisterMadderController](madder-manager#onregistermaddercontroller) event to listen for
...
[OnUpdateMadderControllerState](madder-manager#onupdatemaddercontrollerstate) event to interact with the Madder
...
your convenience shoul you find a need for it.
